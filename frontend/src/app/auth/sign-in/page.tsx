...
import { RiArrowLeftLine, RiLockLine, RiMailLine, RiEyeLine, RiEyeOffLine } from 'react-icons/ri';
      ...
      <div className="container max-w-md mx-auto px-4 py-16 flex-1 flex flex-col justify-center relative z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Sign in to access your ForexJoey dashboard</p>
          </div>
